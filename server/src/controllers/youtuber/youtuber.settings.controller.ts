...
const updateSettings = asyncHandler(async (req: RequestType, res) => {
    ...
    if (jwtSecret) {
        ...
        req.user.username = allowedUpdates.username ? allowedUpdates.username : req.user.username;
        req.user.name = allowedUpdates.name ? allowedUpdates.name : req.user.name;
        req.user.profilepic = allowedUpdates.profilepic
            ? allowedUpdates.profilepic
            : req.user.profilepic;

        const { exp, ...userDataToSend } = req.user;
        await jwtSign({
            userDataToSend,
            jwtSecret,
            res,
...
export { settingPageFetch, updateSettings };
