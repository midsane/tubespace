...
export const WorkspaceCardSection: React.FC = () => {
    ...
    return (
        <div
            ref={scrollDivRef}
            className="w-[85%] scroll-smooth overflow-x-scroll rounded-3xl flex justify-start gap-10 py-10 px-9  h-min-10 bg-black border border-white/10 h-[80%] items-center " >
