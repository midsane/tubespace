...
interface youtuberCardInterface extends Partial<userInterface> {
    extraTStyle: string,
}

export const YoutuberCard = ({ extraTStyle, ...restFields }: youtuberCardInterface) => {
        ...
        <CardWrapper extraTStyle={extraTStyle}>
            <>
                ...
                <div className="w-full flex justify-between gap-4 ">
                    <Button
                        onClick={() => navigate(`/y/${restFields.username}/home`)}
